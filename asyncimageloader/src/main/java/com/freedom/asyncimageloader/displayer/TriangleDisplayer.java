...
public class TriangleDisplayer extends TransformDisplayer.EmptyDisplayer {
	...
	public Bitmap transformBitmap(Resizer resizer,Bitmap b, LoaderSettings request) {
		...
		Bitmap roundBitmap = BitmapUtils.toTriangleCroppedBitmap(bitmap, w);
		return roundBitmap;
	}
